...
#define FRAMAC_MALLOC_INDIVIDUAL
...
int main( int argc, char *argv[] )
{
     ...
     */
#ifndef __FRAMAC__
    // FIXME: le parsing et vérification des certificats amène à des imprécisions qui amènent à des garbled_mix, récursion via pointeurs de fonction, etc...
...
#ifndef __FRAMAC__
    //FIXME: si on définit un CA, plus tard on essayera de le vérifier et l'analyse va perdre de la précision partout
...
reset:
	...
	//#ifdef __FRAMAC__
	//	ssl.state = Frama_C_interval(0,15);
	//#endif
